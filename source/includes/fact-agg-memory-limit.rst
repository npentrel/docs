...
Examples of stages that can exceed the memory limit when
...
If the results of one of your pipeline stages exceed the limit,
consider reducing the byte-size of the output by renaming long field
names or values or removing unnecessary information. If you're using
:pipeline:`$sort`, consider :ref:`adding a $limit
stage<sort-limit-sequence>`.
